...
//     img.src = `${item.photo}`;
//    
//     div.innerHTML = `<div>${item.surname} ${item.name} - ${item.age} <br><br> ${item.info} </div>`;
//    
...
simpsons.forEach(element => {
    ...
    h1.innerText = `${element.name} ${element.surname} \n ${element.age} років`;
    ...
    document.body.style.paddingInline = "0 200px";
...
//     ul.classList.add("duration_list");
//     liMonth.classList.add("month");
//     liHour.classList.add("hour");
//     technologies.classList.add("technologies");
//     ulTech.classList = "techList";
//     document.body.style.display = "flex";
...
//     liMonth.innerHTML = `<b>${element.monthDuration} міс. </b>`;
//     liHour.innerHTML = `<b>${element.hourDuration} год.<b>`;
//
//     for (const item in element.modules) {
//         let liTech = document.createElement("li");
//         liTech.classList = "techListItem";
//         liTech.innerText = `${element.modules[item]}`;
//
//         ulTech.appendChild(liTech);
//     }
//
//     document.body.appendChild(wrap);
//     wrap.append(title, duration, technologies);
//     duration.appendChild(ul);
//     ul.appendChild(liMonth);
//     ul.appendChild(liHour);
//     technologies.appendChild(ulTech);
// }